...
<header id="top">
	<div class="container_12 clearfix">
		<div id="logo" class="grid_5">
			...
			<a id="site-title" href="dashboard.html"><span>ADMINISTRATOR</span><br><span>E-Learning SD SLTP SMA SMK</span></a>
		</div>
...
<footer id="bottom">
	<section class="container_12 clearfix">
		...
		<div class="grid_6 alignright">
			Copyright &copy; 2009 <a href="#">>E-Learning SD, SLTP, SLTA/SMK</a>
		</div>
	</section>
</footer>
